...
import { TrendingUp, AlertCircle, CheckCircle, Clock, Filter, Download, User, MapPin, Map, GitBranch, Shield, Wrench, Lock, BarChart2, GitMerge, LayoutDashboard, Flag } from 'lucide-react';
...
const AdminDashboard: React.FC = () => {
  ...
  const loadReportsData = async () => {
    try {
      ...
      transformedReports.forEach((r: Report) => { const dept = r.category || 'Other'; departmentCounts[dept] = (departmentCounts[dept] || 0) + 1; });
      ...
      const globalStats = await apiService.getGlobalStats();
      ...
      <main className="flex-1 min-w-0 flex flex-col h-screen overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-8">
          ...
          <div className="animate-fade-up">
            {activeTab === 'analytics' && <div className="card p-6 min-h-[500px]"><AnalyticsDashboard reports={reports} stats={stats} /></div>}
