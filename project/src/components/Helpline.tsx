      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Helpline Numbers</h1>
            <p className="text-gray-600">For button phone users - Call directly to report issues</p>
          </div>
            ...
            {helplineNumbers.map((helpline, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">{helpline.department}</h3>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <div className="flex-1">
                    <label className="block text-xs font-medium text-gray-500 mb-1">TOLL-FREE NUMBER</label>
                    <button
                  ...
                  {/* USSD Short Code */}
                  <div className="flex-1">
                    <label className="block text-xs font-medium text-gray-500 mb-1">USSD SHORT CODE</label>
                    <button
